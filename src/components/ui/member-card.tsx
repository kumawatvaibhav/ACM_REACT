...
export function MemberCard({ name, role, image, github, linkedin }: MemberProps) {
  return (
    <Card className="overflow-hidden group hover:shadow-[0_0_15px_rgba(0,255,255,0.3)] transition-all duration-300 transform hover:-translate-y-2 bg-[#0a192f]/80 border-cyan-500/20 backdrop-blur-sm">
